...
import kotlinx.android.synthetic.main.fragment_my_profile_info.changeImageIconTextView
import kotlinx.android.synthetic.main.fragment_my_profile_info.changeUserIconImageView
import kotlinx.android.synthetic.main.fragment_my_profile_info.changeUserIconTextView
import kotlinx.android.synthetic.main.fragment_my_profile_info.circleImageView
import kotlinx.android.synthetic.main.fragment_my_profile_info.infoButton
import kotlinx.android.synthetic.main.fragment_my_profile_info.mailAddressEditText
import kotlinx.android.synthetic.main.fragment_my_profile_info.mainNameTextView
import kotlinx.android.synthetic.main.fragment_my_profile_info.nameEditText
import kotlinx.android.synthetic.main.fragment_my_profile_info.notSettingWalletTextView
import kotlinx.android.synthetic.main.fragment_my_profile_info.phoneNumberEditText
import kotlinx.android.synthetic.main.fragment_my_profile_info.rubyEdiText
import kotlinx.android.synthetic.main.fragment_my_profile_info.subNameTextView
import kotlinx.android.synthetic.main.fragment_my_profile_info.userScreenImageView
...
class MyProfileInfoFragment : BaseFragment() {
  ...
  override fun onAttach(context: Context?) {
    ...
    myProfileInfoViewModel = ViewModelProviders.of(this, viewModelFactory)
        .get(MyProfileInfoViewModel::class.java)
  }
  ...
  private fun setupImageViewsClickListener() {
    circleImageView.setOnClickListener {
      startActivityForResult(
          CropImageActivity.createIntent(
              circleImageView.context, CropImageView.CropMode.CIRCLE_SQUARE
    ...
    userScreenImageView.setOnClickListener {
      startActivityForResult(
          CropImageActivity.createIntent(
              userScreenImageView.context, CropImageView.CropMode.RATIO_16_9
  ...
  private fun enableEditImageViews() {
    ...
    circleImageView.background =
      getDrawable(circleImageView.context, R.drawable.foreground_circle_icon_gray_scale)
  ...
  private fun disableEditImageViews() {
    ...
    circleImageView.setBackgroundColor(
        circleImageView.context.getColorFromResource(android.R.color.transparent)
    )
  ...
  private fun setCircleImage(uriString: String) {
    Picasso.with(circleImageView.context)
        .load(uriString)
  ...
  private fun setUserScreenImageView(uriString: String) {
    Picasso.with(userScreenImageView.context)
        .load(uriString)
