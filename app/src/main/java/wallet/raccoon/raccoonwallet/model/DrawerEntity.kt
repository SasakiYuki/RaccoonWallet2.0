...
enum class DrawerItemType(
  ...
  ADDRESS_BOOK(
      R.mipmap.icon_menu_addresbook, R.string.main_navigation_address_book, DrawerType.MAIN
  ),
  MOSAIC_GALLERY(
      R.mipmap.icon_menu_mosaic, R.string.main_navigation_mosaic_gallery, DrawerType.MAIN
  ),
